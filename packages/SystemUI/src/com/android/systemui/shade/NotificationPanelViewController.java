...
public final class NotificationPanelViewController implements
    ...
    void flingToHeight(float vel, boolean expand, float target,
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationCancel(Animator animation) {
                mCancelled = true;
                SystemUIBoostFramework.getInstance().animationBoostOff(
    ...
    private void onTrackingStarted() {
        SystemUIBoostFramework.getInstance().animationBoostOn(
                SystemUIBoostFramework.REQUEST_ANIMATION_BOOST_TYPE_TRACKING_NOTIFICATION_PANEL_VIEW);
        endClosing();
    ...
    void notifyExpandingStarted() {
        ...
        SystemUIBoostFramework.getInstance().animationBoostOn(
                SystemUIBoostFramework.REQUEST_ANIMATION_BOOST_TYPE_SPEED_UP_QS_EXPANSION_ANIMATION);
    }
