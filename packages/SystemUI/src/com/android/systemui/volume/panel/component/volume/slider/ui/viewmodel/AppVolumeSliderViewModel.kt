...
/** Models a per-app volume slider in the volume panel. */
...
constructor(
    ...
    private fun resolveAppIcon(): Icon.Loaded =
        runCatching { context.packageManager.getApplicationIcon(packageName) }
            ...
            .asIcon(contentDescription = ContentDescription.Loaded(appLabel))
