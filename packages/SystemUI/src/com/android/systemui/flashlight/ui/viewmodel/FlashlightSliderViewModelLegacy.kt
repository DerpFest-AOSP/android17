...
constructor(
    ...
    override val currentFlashlightLevel: FlashlightModel.Available.Level? by
        _currentFlashlightLevel.asStateFlow().hydratedStateOf()

    override val isFlashlightAdjustable: Boolean by
        flowOf(flashlightController.isStrengthControlSupported())
            .hydratedStateOf(flashlightController.isStrengthControlSupported())
