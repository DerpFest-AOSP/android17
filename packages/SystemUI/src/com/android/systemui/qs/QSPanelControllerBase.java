...
public abstract class QSPanelControllerBase<T extends QSPanel> extends ViewController<T>
    ...
    private static final String QS_PANEL_STYLE_SETTING = "qs_panel_style";
    ...
    private final ContentObserver mQsTileStyleObserver = new ContentObserver(
        ...
        public void onChange(boolean selfChange) {
            int newStyle = Settings.Secure.getIntForUser(
                    getContext().getContentResolver(), QS_PANEL_STYLE_SETTING, 0,
    ...
    protected void onViewAttached() {
        ...
        getContext().getContentResolver().registerContentObserver(
                Settings.Secure.getUriFor(QS_PANEL_STYLE_SETTING), false,
                mQsTileStyleObserver, UserHandle.USER_ALL);
