...
.pointerInput(Unit) {
    detectTapGestures(
        ...
        BoxWithConstraints(modifier = Modifier.fillMaxWidth()) {
            ...
            val useGradient =
                !isDozing && !isDndEnabled && activeThumbBrush != null && gradientEndColor != null
            ...
            val thumbBorderModifier =
                when {
                    isDozing -> Modifier.border(theme.dozeStroke, Color.White, thumbShape)
                    isDndEnabled -> Modifier.border(2.dp, theme.dndBg, thumbShape)
                    useGradient -> Modifier.border(2.dp, gradientEndColor!!, thumbShape)
                    else -> Modifier.border(2.dp, theme.activeBg, thumbShape)
                }
            Box(
                modifier = Modifier
