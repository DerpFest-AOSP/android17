...
public class SettingsHelper {
    ...
    private void setRingtone(String name, String value) {
        ...
        final int ringtoneType = getRingtoneType(name);
        final int slotId = Settings.System.RINGTONE2.equals(name) ? 1 : 0;
        if (SILENT_RINGTONE.equals(value)) {
            // SILENT_RINGTONE is a special constant generated by onBackupValue in the source
            // device.
            RingtoneManager.setActualDefaultRingtoneUriBySlot(mContext, ringtoneType, null, slotId);
            return;
        }
        ...
        if ((ringtoneType == RingtoneManager.TYPE_RINGTONE
            ...
            if (ringtoneUri != null && vibrationUri != null) {
                ...
                RingtoneManager.setActualDefaultRingtoneUriBySlot(
                        mContext, ringtoneType, ringtoneUri, slotId);
                return;
            }
        }
